...
<html>
	<head>
	    ...
	    <!-- Tempusdominus Bootstrap 4 -->
	     ...
	     <link rel="stylesheet" href="<c:url value="/resources/css/daily-edit.css"/>"> 
	</head>
    ...
    <section class="content pt-2 pb-1">
      ...
      <form class="form-horizontal" id="addDailyForm">
		<div class="form-group row">
				<input type="hidden" id="hdExpenseId" value="${expenseBean.id}"/>
				<input type="hidden" id="hdBusId" value="${expenseBean.busId}"/>
				<input type="hidden" id="hdPath" value="${expenseBean.path}"/>
               ...
               <div class="col-sm-2">
	              ...
	              <div class="col-sm-3">
	               <div class="input-group"> 
                    ...
                    <input type="text" class="form-control float-right" id="dateRange" value="${expenseBean.fromDateAsString} - ${expenseBean.toDateAsString}">
                  </div>
                  </div>
            ...
            <div class="form-group row no-rest">
              <label for="receivedDate" class="col-sm-2 col-form-label text-right">On Paper Income (Leave)<span class="required">[required]</span> </label>
               <div class="col-sm-2">
                    <input type="number" class="form-control" style="width: 100%;" id="onPaperIncomeLeave" name="onPaperIncomeLeave" min="0" value="${expenseBean.onPaperIncomeLeave}"/>
	              </div>
               ...
               <div class="col-sm-2">
                    <input type="number" class="form-control" style="width: 100%;" id="onPaperIncomeReturn" name="onPaperIncomeReturn" min="0" value="${expenseBean.onPaperIncomeReturn}"/>
	              </div>
               ...
               <div class="col-sm-2">
                    <input type="number" class="form-control" style="width: 100%;" id="inHandCash" name="inHandCash" min="0" value="${expenseBean.inHandCash}"/>
	              </div> 
             ...
             <div class="form-group row no-rest">
              <label for="receivedDate" class="col-sm-2 col-form-label text-right">Extra Income From Hitchhikers </label>
               <div class="col-sm-2">
                    <input type="number" class="form-control" style="width: 100%;" id="extraIncome" name="extraIncome" min="0" value="${expenseBean.extraIncome}"/>
	              </div>
        ...
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Confirm Edit Daily Income/Expense</h4>
          		...
          		<div class="card-body del-card">
            		<div class="form-group row">
              			<label class="col-sm-12 col-form-label">
              				Are you sure you want to edit Daily Income/Expense: <span id="delName"></span>?
              				<br>
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-outline-primary" id="confirmDaily">YES</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
  ...
  <!-- DataTables  & Plugins -->
	...
	<script src="<c:url value="/resources/js/daily-edit.js"/>"></script>
