      ...
      <div class="card">
          ...
          <div class="row">	
	        <div class="col-sm-10"></div>
          	<div class="col-sm-2">
	             	 <button type="button" class="btn btn-primary float-right" id="addDriver">
	                   Add Driver
	                  </button>
	            </div>
        ...
        <div class="modal-dialog modal-xs">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary" id="deleteDriver">YES</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
        ...
        <form class="form-horizontal" id="editDriverForm">
          ...
          <!-- /.card-footer -->
            ...
            <input type="hidden" id="editDriverId"/>
              <button type="button" class="btn btn-default cancel" data-dismiss="modal">Cancel</button>
              <button type="button" class="btn btn-primary" id="editDriver">Save Changes</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
