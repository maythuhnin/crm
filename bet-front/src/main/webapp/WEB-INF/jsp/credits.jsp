...
<link rel="stylesheet" href="<c:url value="/resources/css/credits.css"/>" type="text/css" />
<link href="<c:url value="/resources/plugins/fontawesome-free/css/all.css" />" rel="stylesheet">
</head>
<body id="body" class="theme--dark">
  <div id="container">  
  	<div class="header">
      <label class="night-mode">
        <a href="https://m.me/t.thu98" target="_blank"><i class="fab fa-facebook-messenger"></i></a>
      </label>
    </div>   
