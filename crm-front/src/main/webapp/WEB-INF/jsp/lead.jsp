...
<html>
	<head>
	    ...
	    <link rel="stylesheet" href="<c:url value="/resources/css/lead.css"/>"> 
	</head>
  ...
  <div class="content-wrapper">
      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
			    ...
			    <div class="col-sm-3">
			        <select class="form-control select2 select-filter" style="width: 100%;" id="searchCompany">
			        	<option></option>
			        </select>
			    </div>
			     <div class="col-sm-3">
        ...
        <div class="card-body">
          <table id="leadDatatable" class="table table-bordered">
            <thead>
            <tr>
              <th>Contact Name</th>
              <th>Company</th>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title lead-title">Add Bus</h4>
                <button type="button" class="close close-lead" data-dismiss="modal" aria-label="Close">
        ...
        <form class="form-horizontal" id="addBusForm">
          ...
          <!-- /.card-footer -->
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default cancel close-lead" data-dismiss="modal">Cancel</button>
	...
	<div class="modal fade" id="editBusModal">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title lead-title">Edit Bus</h4>
                <button type="button" class="close close-lead" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
	...
	<div class="modal fade" id="deleteModal">
          		...
          		<div class="card-body del-card">
            		<div class="form-group row">
              			<label class="col-sm-12 col-form-label">
              				Are you sure you want to delete lead : <span id="delName"></span>?
             				<br>
              				<span class="delete-text text-danger">This lead will be removed in all added Fixed Expenses as well.</span>
             				<br><br>
      ...
      <div class="modal fade" id="driverModal">
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title lead-title">Add Driver</h4>
...
<script src="<c:url value="/resources/js/lead.js"/>"></script>
